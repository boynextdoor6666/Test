...
async function submitReview() {
  ...
  try {
    // Используем API для отправки отзыва о работнике
    ...
    if (response.success) {
      successMessage.value = 'Спасибо за ваш отзыв о работнике!'
      review.value = ''
      rating.value = 0
...
<template>
  <div class="review-form">
    <h3>Оставить отзыв о работнике</h3>
    ...
    <div class="form-group">
      ...
      <textarea 
        ...
        class="form-control" 
        rows="4" 
        placeholder="Расскажите о вашем опыте работы с этим работником..."
      ></textarea>
    </div>
